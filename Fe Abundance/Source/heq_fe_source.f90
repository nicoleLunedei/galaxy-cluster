...
open(20, file='initial_fe_source.dat' )

!!!!!!!!!!!Saving the final values!!!!!!!!
open(40, file= 'final_fe_source.dat')
...
do j = 1, jmax
 ...
 write(20,1004) rr(j)/cmkpc, zfe_obs(j), zfe_ex(j)
enddo
...
!!!!!!!!!!!!!!!!!!!!!Source function: Stellar winds & SNIa!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   s_fe(j) = rho_hern(j) * (6d-23 + 4.7d-22)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      rho_fe(j) = rho_fe(j) + s_fe(j)
