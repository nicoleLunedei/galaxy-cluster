!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!! Codice per il caso solo sorgente, con l'opzione di scegliere da terminale se 
!! avere i coefficienti stellare e delle supernovae costanti o variabili nel tempo
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
real*8 :: msol,mu,mp,rmin,rmax,mvir,rvir,mbgc,ahern,&
          ...
          alpha_hern, alpha_Ia, zfe_Ia, coeff, M_fe_theor
!constants
...
open(40, file= 'final_fe_source.dat')        !!file for the constant coefficients case
!open(50, file= 'Mass_fe_source.dat')
...
do j = 1, jmax
 ...
 zfe_ex(j) = zfe_obs(j) - zfe_ground   !!!!zfe_ex is reffering to data of the Fe abundance without the background contribution!!  
