!******************************************************************
!  Programma di calcolo di rhobest con turbolenza (prima versione di Andrea)
!*****************************************************************
...
real*8, dimension(nvt) :: vt_values = (/ 200.0d0, 300.0d0, 400.0d0, 500.0d0 /) !vt appartien a intervallo 200-400 km/s 
